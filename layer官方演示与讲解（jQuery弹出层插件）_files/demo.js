...
layer.ready(function(){
  ...
  layer.open({
    ...
    ,shade: false
    ,resize: false
    ,content: '<div id="LAY_layuipro" style="padding: 50px; line-height: 22px; background: url(//res.layui.com/images/layui/banner1.jpg) center 0; color: #fff; font-weight: 300;">你知道吗？亲！<br>layer终于不再独孤。<br><br>因为就在前几天，我们发布了Layui 1.0 正式版，这对我们而言，是一个崭新的起点。<br><br>layer虽然已被 Layui 收编为内置的弹层模块，但仍然会作为一个独立组件全力维护、升级。<br><br>看！我们的征途是星辰大海 ^_^</div>'
    ,btn: ['火速围观', '残忍拒绝']
    ,move: '#LAY_layuipro'
    ,moveType: 1
